...
def stat_dist(Parameters, Microbes, Host, TT):  # Obtain microbe abundances at 1000th time-step for TT many trials with
...
stat = stat_dist(Parameters, Microbes, Host, 10000)

sns.set_theme()
sns.stripplot(data=stat.T)
plt.xlabel("Microbe")
plt.ylabel("Abundance")
plt.title("Stationary abundances for random microbe trait samples (N=10)\n and random initial abundances (10,000 trials)")
plt.show()